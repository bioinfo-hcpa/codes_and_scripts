...
ddF <- dada(derepFs[1:79], err=NULL, selfConsist=TRUE, MAX_CONSIST = 20, multithread = TRUE) #Ajustar o intervalo entre chaves com o número de amostras.
ddR <- dada(derepRs[1:79], err=NULL, selfConsist=TRUE, MAX_CONSIST = 20, multithread = TRUE) #Ajustar o intervalo entre chaves com o número de amostras.
...
mergers <- mergePairs(dadaFs, derepFs, dadaRs, derepRs, verbose = TRUE, multithread = TRUE)
...
taxtab <- addSpecies(taxtab, "/home/metagenomica/Bancos_de_dados/SILVA/silva_species_assignment_v138.1.fa.gz", multithread = TRUE)
